 ...
 * 
 * 
 * https://developers.google.com/youtube/v3/code_samples/code_snippets?apix_params=%7B%22part%22%3A%5B%22snippet%2CcontentDetails%2Cstatistics%22%5D%2C%22id%22%3A%5B%22Ks-_Mh1QhMc%22%5D%7D
 */
...
public class ApiExample {
    private static final String CLIENT_SECRETS = "client_secret_SpeedSkating_Channel.json";
...
//        InputStream in = ApiExample.class.getResourceAsStream(CLIENT_SECRETS);
        File initialFile = new File(CLIENT_SECRETS);
...
//     	Define the Video object, which will be uploaded as the request body.
        ...
        File mediaFile = new File("C:\\Users\\AlexL\\eclipse-workspace\\WorldSkateTvScraper\\speed\\Cali_2007_-_World_Championships\\Cali_2007_-_Speed_Skating_World_Championships.mp4");
...
//        Video response = request.setKey("AIzaSyC-jAIrC1Ev2shM2NVIpOmpAV0bo2MxqpU").execute();
