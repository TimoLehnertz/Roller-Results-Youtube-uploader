...
public class ThumbnailTest {
	 ...
	 private static final String CLIENT_SECRETS= "client_secret_SpeedSkating_Channel.json";
	    ...
	    private static final String APPLICATION_NAME = "The Speedskating Channel";
...
//	      InputStream in = ApiExample.class.getResourceAsStream(CLIENT_SECRETS);
	    ...
	    public static void main(String[] args) throws GeneralSecurityException, IOException, GoogleJsonResponseException {
	        ...
	        File mediaFile = new File("2013_World_Games_-_Cali__Colombia.jpg");
	        ...
	        YouTube.Thumbnails.Set request = youtubeService.thumbnails().set("42eCjDufasg", mediaContent);
